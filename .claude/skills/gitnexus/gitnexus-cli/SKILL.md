---
name: gitnexus-cli
description: Inspect or maintain a GitNexus index, or generate a requested graph wiki. Use for explicit CLI/index tasks or a necessary index repair.
---
...
Verify index status and review any generated AGENTS.md / CLAUDE.md changes. Preserve project-specific rules and concise pointers; do not silently restore duplicated boilerplate. Continue only with the skill relevant to the original task.
