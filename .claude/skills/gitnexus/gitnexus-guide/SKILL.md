---
name: gitnexus-guide
description: Reference GitNexus tools, resources, and graph schemas when their usage or result format needs clarification.
---
...
## Use Only the Needed Reference

Follow [AGENTS.md](../../../../AGENTS.md) for repository rules. Read the tool or schema section needed for the question; this guide is not a prerequisite for every code task. Use the current tool schema when it differs from an example. Check index freshness when graph completeness matters.
